<?php  
if(isset($_GET["mproduct_category_id"])){
...
<head>
    ...
    <meta name="csrf-token" content="eHRJV3FfTWoBNnwlIDg1JD43eh0hLTkJQDB8OzNnfwcCJhZmBQgEMw==">
...
</ul>        <div class="product-index">

    <h1>Products</h1>
    
    <p>
        <a class="btn btn-success" href="/basic/web/index.php?r=product%2Fcreate">Create Product</a>    </p>
    <div id="w0" class="grid-view"><div class="summary">Showing <b>1-20</b> of <b>20</b> items.</div>
<table class="table table-striped table-bordered"><thead>
<tr><th>#</th><th><a href="/basic/web/index.php?r=product%2Findex&amp;sort=product_id" data-sort="product_id">Product ID</a></th><th><a href="/basic/web/index.php?r=product%2Findex&amp;sort=product_category_id" data-sort="product_category_id">Product Category ID</a></th><th><a href="/basic/web/index.php?r=product%2Findex&amp;sort=product_name" data-sort="product_name">Product Name</a></th><th><a href="/basic/web/index.php?r=product%2Findex&amp;sort=product_price" data-sort="product_price">Product Price</a></th><th class="action-column">&nbsp;</th></tr><tr id="w0-filters" class="filters"><td>&nbsp;</td><td><input type="text" class="form-control" name="SearchProduct[product_id]"></td><td><input type="text" class="form-control" name="SearchProduct[product_category_id]"></td><td><input type="text" class="form-control" name="SearchProduct[product_name]"></td><td><input type="text" class="form-control" name="SearchProduct[product_price]"></td><td>&nbsp;</td></tr>
</thead>
<tbody>
...
$input = "<tr data-key='0'><td>$i</td><td>{$subject["product_id"]}</td><td>{$subject["product_category_id"]}</td><td>{$subject["product_name"]}</td><td>{$subject["product_price"]}</td><td><a href='/basic/web/index.php?r=product%2Fview&amp;id=0' title='View' aria-label='View' data-pjax='0'><span class='glyphicon glyphicon-eye-open'></span></a> <a href='/basic/web/index.php?r=product%2Fupdate&amp;id=0' title='Update' aria-label='Update' data-pjax='0'><span class='glyphicon glyphicon-pencil'></span></a> <a href='/basic/web/index.php?r=product%2Fdelete&amp;id=0' title='Delete' aria-label='Delete' data-pjax='0' data-confirm='Are you sure you want to delete this item?' data-method='post'><span class='glyphicon glyphicon-trash'></span></a></td></tr>";
...
<div id="yii-debug-toolbar" data-url="/basic/web/index.php?r=debug%2Fdefault%2Ftoolbar&amp;tag=591343ae45f6d" style="display:none" class="yii-debug-toolbar-bottom"></div><style>
...
jQuery('#w0').yiiGridView({"filterUrl":"\/basic\/web\/index.php?r=product","filterSelector":"#w0-filters input, #w0-filters select"});
});</script></body>
</html>
